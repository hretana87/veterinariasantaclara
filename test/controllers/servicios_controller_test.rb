...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post servicios_url, params: { servicio: { description: @servicio.description, name: @servicio.name } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { description: @servicio.description, name: @servicio.name } }
